...
config :kove, KoveWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: KoveWeb.ErrorHTML, json: KoveWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Kove.PubSub,
  live_view: [signing_salt: "i0Cr7Kli"]
...
config :kove, Kove.Mailer, adapter: Swoosh.Adapters.Local
