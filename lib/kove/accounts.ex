defmodule Kove.Accounts do
  ...
  alias Kove.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Kove.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Kove.Accounts.User.password_changeset/3` for a list of supported options.
  ...
  @doc """
  Generates a magic link token for a user without sending an email.
