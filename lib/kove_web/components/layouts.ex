defmodule KoveWeb.Layouts do
  ...
  def app(assigns) do
    ~H"""
    <header class="navbar bg-base-200/60 backdrop-blur-sm sticky top-0 z-40 px-4 sm:px-6 lg:px-8 border-b border-base-300">
      <div class="flex-1">
        <a href="/" class="flex items-center gap-2 font-black text-xl tracking-tight">
          <span>KOVE</span>
          <span class="text-primary">MOTO</span>
        </a>
      </div>
      <div class="flex-none">
